...
namespace ProfileCut
{
    ...
    ///</summary>
    public class ProfileCutPlugIn : Rhino.PlugIns.PlugIn

    {
        ...
        public static ProfileCutPlugIn Instance
        {
            get; private set;
        }
        ...
        protected override Rhino.PlugIns.LoadReturnCode OnLoad(ref string errorMessage)
        {
            ...
            Rhino.UI.Panels.RegisterPanel(this, panelType, "ProfileCutPanel", System.Drawing.SystemIcons.Question);
        ...
        public int GetLayerIndex(string layer_name)
        {
            ...
            int layer_index = Doc.Layers.Find(layer_name, true);  //Rhino5 -> Rhino7では、非推奨になっている。
            if (layer_index < 0)
            {
        ...
        */
        ...
        public void ConvertPrecision2()
        {
            ...
            if (path != null)
            {
                ...
                ProfileCutPlugIn.RunScript("SKProfileCutConvert.py", param, true);
            }
        }
        ...
        {
            ProfileCutPlugIn.RunScript("SKProfileCutDelete.py");
        }
    }
}